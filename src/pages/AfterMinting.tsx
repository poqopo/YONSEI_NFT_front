...
export default function AfterMinting() {
  ...
  return (
    <div
      id="nftcapture"
      className="h-screen flex flex-col font-roboto text-[#090707] text-center"
    >
      <button
        type="button"
      ...
      <p className="text-[#090707]">
        <span className="font-bold">나는 이제부터 {major} 아기독수리🐣💙</span>
        <br /> <br /> 오히려 좋아!! <br /> 새로운 건 언제나 즐거우니까😎 <br />{' '}
        이제 우리 더 친해져 보자구! <br />
        아래 공유하기 버튼을 눌러서 <br /> 바로 나 도팜희를 친구들에게
        소개해줘!🐥
      </p>
      <CustomButton text="공유하기" onClick={() => captureAndShare()} />
      <CustomButton
