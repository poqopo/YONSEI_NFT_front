...
const EducationalScienceOptions = [
  { value: '180', label: '체육교육학과' },
  { value: '181', label: '스포츠응용산업학과' },
  { value: '182', label: '교육학부' },
];
...
const GlobalLeadersOptions = [{ value: '106', label: '글로벌인재대학' }];

const UICOptions = [
  { value: '190', label: 'UD' },
  { value: '195', label: 'HASSD' },
  { value: '197', label: 'HASSD(AS)' },
...
export const groupedOptions = [
  ...
  {
    label: '교육과학대학',
    options: EducationalScienceOptions,
  },
  {
    label: '의과대학',
